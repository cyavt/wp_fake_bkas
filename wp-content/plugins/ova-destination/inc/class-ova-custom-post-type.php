	...
	class OVADESTINATION_custom_post_typel{
		...
		function OVAdestination_register_post_type_destination() {
			$labels = array(
				...
				'name_admin_bar'        => __( 'Destinations', 'ova-destination' ),
				...
				'add_new'               => __( 'Add New Destination', 'ova-destination' ),
		...
		function OVAdestination_register_taxonomy_destination(){
			$labels = array(
				'name'                       => _x( 'Category Destination', 'Post Type General Name', 'ova-destination' ),
				'singular_name'              => _x( 'Category Destination', 'Post Type Singular Name', 'ova-destination' ),
				'menu_name'                  => __( 'Category Destination', 'ova-destination' ),
				'all_items'                  => __( 'All Category Destination', 'ova-destination' ),
