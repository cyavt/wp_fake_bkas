...
class ova_destination_slider extends Widget_Base {
	...
	public function get_script_depends() {
		wp_enqueue_style( 'owl-carousel', OVADESTINATION_PLUGIN_URI.'assets/libs/owl-carousel/assets/owl.carousel.min.css' );
		wp_enqueue_script( 'owl-carousel', OVADESTINATION_PLUGIN_URI.'assets/libs/owl-carousel/owl.carousel.min.js', array('jquery'), false, true );
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'ova_destination_met_order_destination' => __( 'Custom Order', 'ova-destination' ),
				],
			]
		);
		...
		$this->start_controls_section(
        	...
        	$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ova-destination-slider .item-destination .info .count-tour',	
				]
			);
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'type' 		=> Controls_Manager::COLOR,
	                'selectors' => [
	                    '{{WRAPPER}} .ova-destination-slider .item-destination .info .count-tour' => 'color: {{VALUE}}',
	                ],
	            ]
	        );
	        ...
	        $this->add_control(
	            ...
	            [
	                ...
	                'type' 		=> Controls_Manager::COLOR,
	                'selectors' => [
	                    '{{WRAPPER}} .ova-destination-slider .item-destination .info .count-tour' => 'background-color: {{VALUE}}',
	                ],
	            ]
	        );
			...
			$this->add_responsive_control(
	            ...
	            [
	                ...
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	                    '{{WRAPPER}} .ova-destination-slider .item-destination .info .count-tour' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	                ],
	            ]
	        );
	        ...
	        $this->add_responsive_control(
	            ...
	            [
	                ...
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	                    '{{WRAPPER}} .ova-destination-slider .item-destination .info .count-tour' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	                ],
	            ]
	        );
		...
		$this->start_controls_section(
            'dots_style',
            [
                'label' => esc_html__( 'Dots (Mobile)', 'ova-destination' ),
                'tab' 	=> Controls_Manager::TAB_STYLE,
            ]
        );
