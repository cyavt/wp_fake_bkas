		...
		*/
		$this->start_controls_section(
			...
			$this->add_control(
				'label_view_details',
				[
					'label' => esc_html__( 'View detail', 'ova-brw' ),
		...
		******************************************************************/
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'color_title_hover',
				[
					'label' => esc_html__( 'Color Title Hover', 'ova-brw' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'color_view_detail',
				[
					'label' => esc_html__( 'Color View Detail', 'ova-brw' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Color View Detail Hover', 'ova-brw' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
		    ...
		    $this->add_responsive_control(
				'nav_size',
				[
					'label' => esc_html__( 'Font Size Nav', 'ova-brw' ),
