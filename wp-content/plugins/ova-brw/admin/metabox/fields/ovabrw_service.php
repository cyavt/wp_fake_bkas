							...
							?>
								<tr class="tr_rt_service">
								    ...
								    <td width="15%">
										...
										<?php 
											$selected_person 	= isset( $ovabrw_rs_duration_type[$i] ) && $ovabrw_rs_duration_type[$i] == 'person' ? 'selected' : '';
											$selected_total 	=  isset( $ovabrw_rs_duration_type[$i] ) && $ovabrw_rs_duration_type[$i] == 'total' ? 'selected' : '';
										?>
