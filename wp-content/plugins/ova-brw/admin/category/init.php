...
function ovabrw_save_taxonomy_custom_meta($term_id) {
    ...
    $ovabrw_custom_tax = $_REQUEST['ovabrw_custom_tax'];
    $ovabrw_custom_checkout_field = $_REQUEST['ovabrw_custom_checkout_field'];
    $ovabrw_choose_custom_checkout_field = $_REQUEST['ovabrw_choose_custom_checkout_field'];

    // Get product template
    $product_template           = $_REQUEST['ovabrw_product_templates'];
