...
class Tripgo_Elementor_Blog_Grid extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'color_title',
			[
				'label' => esc_html__( 'Color Title', 'tripgo' ),
		...
		$this->add_control(
			'color_title_hover',
			[
				'label' => esc_html__( 'Color Title Hover', 'tripgo' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', 'em', '%' ],
					'selectors' 	=> [
						'{{WRAPPER}} .ova-blog .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			?>
				<li class="item">
					...
					<?php if(has_post_thumbnail()){ ?>
					    ...
					    <div class="media">
				        	<?php 
				        		$thumbnail = wp_get_attachment_image_url(get_post_thumbnail_id() , 'tripgo_blog_thumbnail' );
				        	?>
