...
class Tripgo_Elementor {
	...
	function tripgo_enqueue_footer_scripts(){
	    ...
	    // Flaticon
	    wp_enqueue_style('ova-flaticon', TRIPGO_URI.'/assets/libs/flaticon/font/flaticon.css', array(), null);
	}
	...
	public function tripgo_button_custom($element, $args){
		$element->start_controls_section(
			...
			$element->add_control(
				...
				[
					'label' => esc_html__( 'Icon Font Size', 'tripgo' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
	...
	public function tripgo_icon_box_custom($element, $args)
	{
		$element->start_controls_section(
			...
			// shappe ,.elementor-view-stacked .elementor-icon
